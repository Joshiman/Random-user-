...
import {FaUser , FaMap ,FaEnvelopeOpen, FaPhone, FaLock, FaCalendarTimes  } from 'react-icons/fa'
...
function App() {
  ...
  const getPerson = async () =>{
    ...
    const newPerson = { image, phone, email, password, age , name: `${first} ${last}`,  street: `${number} ${name}`};
    setPerson(newPerson);
    setLoading(false)
    setTitle(`name`)
